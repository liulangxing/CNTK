...
class ProgressPrinter(ProgressTracker):
    '''DEPRECATED: Please use :class:`cntk.utils.ProgressTracker` instead.'''

    def __init__(self, *args, **kwargs):
        warnings.simplefilter('always', DeprecationWarning)
        warnings.warn('ProgressPrinter class has been deprecated, please use ProgressTracker instead.',
                      category=DeprecationWarning)
        warnings.simplefilter('default', DeprecationWarning)
        super(ProgressPrinter, self).__init__(*args, **kwargs)
